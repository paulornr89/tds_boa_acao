...
@Service
//adiciona a classe ao Context do app como um serviço de autenticação (note que implementa UserDetailsService, o serviço de autenticação de usuários do spring boot)
